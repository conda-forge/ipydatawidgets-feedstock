...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipydatawidgets-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5619&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipydatawidgets-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipydatawidgets` can be installed with:

```
conda install ipydatawidgets
```

It is possible to list all of the versions of `ipydatawidgets` available on your platform with:
